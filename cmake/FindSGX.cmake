cmake_minimum_required(VERSION 3.19) # target_include_directories
...
if(SGX_FOUND)
    ...
    function(add_untrusted_library target mode)
        ...
        target_link_libraries(${target} "${SGX_COMMON_CFLAGS} \
                                         ...
                                         -l${SGX_USVC_LIB} \
                                         -lsgx_ukey_exchange \
                                         -lpthread"  PRIVATE ${_REFLECTION} ${_GRPC_GRPCPP} ${_PROTOBUF_LIBPROTOBUF} ${LIBXML2_LIBRARIES} )
    ...
    function(add_untrusted_executable target)
        ...
        target_link_libraries(${target} "${SGX_COMMON_CFLAGS} \
                                         ...
                                         -l${SGX_USVC_LIB} \
                                         -lsgx_ukey_exchange \
                                         -lpthread"  ${_REFLECTION} ${_GRPC_GRPCPP} ${_PROTOBUF_LIBPROTOBUF} ${LIBXML2_LIBRARIES} )
